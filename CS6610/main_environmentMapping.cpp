...
void initializeScene() {
    ...
    CC::ReflectiveShader* meshShader = new CC::ReflectiveShader();
    ...
    CC::Material* bricksM = new CC::Material(meshShader, 500, CC::vec3(0.95,0.95,0.95), CC::vec3(0.5, 0.5, 0.5));
    CC::RenderObject* teapotRO = new CC::RenderObject(teapot, bricksM);
